...
<input type="number"  id="id_m" name="marque" placeholder="Entrez le numero du la marque " /><br /><br />
...
<a href="admin_espace.php" style="text-decoration:none;">Revenir en arrière</a><br /><br />
