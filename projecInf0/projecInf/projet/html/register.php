...
<div class="input-group">
       ...
       <div class="input-group">
       <label class="lb">Nom d'utilisateur</label>
...
<div class="input-group">
       <label class="lb">Confirmer mot de passe</label>
       <input type="password" name="password_2" placeholder="Confirmer votre mot de passe" id="conpass" autocomplete="off">
	   <span id="confrmpass" class="text-danger font-weight-bold"> </span>
</div>
<div class="input-group">
       <label class="lb">N°téléphone</label>
       <input type="text" name="mobile" placeholder="saisi votre N°téléphone" id="mobileNumber" autocomplete="off">
	   <span id="mobileno" class="text-danger font-weight-bold"> </span>
</div>
<div class="input-group">
       <label class="lb">Date de néssance</label>
...
<div class="input-grou">
    <button type="submit" name="register" class="btn">S'inscrire</button><br><br>
</div>
<p>
       <h4>Déja membre?</h4> <a href="login.php">Connexion</a>
   </p>
   </form>
